...
class World:
    ...
    def __init__(self, show_agent):
        ...
        self.agent_location = []
        self.create()
        self.agent_location = self.init_location()
        self.background = np.copy(self.get_surface())
        self.target_location = self.init_location()
        self.turn = 0
        self.max_turns = 2000
        self.is_mdp = False
        self.draw()
    ...
    def draw(self):
        ...
        pygame.draw.rect(screen, RED, (self.target_location[0], self.target_location[1], ROBOT_SIZE, ROBOT_SIZE))
        if self.show_agent:
    ...
    def init_location(self):
        while True:
            ...
            if i == 0:
                ...
                y = np.random.randint(10, 700)
                if not self.check_surface_for_position(5, y, ROBOT_SIZE):
                    location = [WORLD_SIZE[0] - ROBOT_SIZE - 2, y]
                    break
